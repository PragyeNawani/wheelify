        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl font-bold mb-6">
              Find Your Perfect Ride with Wheelify
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Rent premium cars at affordable prices. Your journey starts here.
            </p>
            <Link
              href="/cars"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-bold mb-2">Verified Cars</h3>
              <p className="text-gray-600">
                All cars are regularly maintained and thoroughly inspected.
              </p>
            </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
            {['Sedan', 'SUV', 'Hatchback', 'Luxury', 'Sports'].map((category) => (
              <Link
                key={category}
      ...
      <section className="bg-blue-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            Book your car today and enjoy a seamless rental experience.
          </p>
          <Link
            href="/cars"
            className="bg-white text-blue-600 px-8 py-3 rounded-lg text-lg font-semibold hover:bg-gray-100 transition inline-block"
